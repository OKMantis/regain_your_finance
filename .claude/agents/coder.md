...
5. Add inline comments only where the reasoning is non-obvious
6. Run the app after significant changes to catch runtime errors early

**Rules:**
- Always read existing code before editing to avoid duplication or conflicts
- Never skip validations or leave security holes (always scope queries, never trust raw params)
